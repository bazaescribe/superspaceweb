        ...
        <div className={styles.fragments} inert={connected} aria-hidden={connected}>
          <article className={`${styles.card} ${styles.email}`}>
            <div className={styles.cardBar}>
              <span className={styles.mailMark}><Mail size={13} /></span>
              <span>Inbox <small>All mail</small></span>
              <MoreHorizontal size={16} />
            </div>
            <div className={styles.cardBody}>
              <div className={styles.meta}>NORTHSTAR SUPPLY <span>·</span> ORDER #1048</div>
              ...
              <div className={styles.mailActions}><span>↩ &nbsp; Reply</span><span>Forward</span></div>
            </div>
          </article>
          <article className={`${styles.card} ${styles.sheet}`}>
            <div className={styles.cardBar}>
              <span className={styles.sheetMark}><FileSpreadsheet size={13} /></span>
              <span>Orders_final_v3.xlsx <small>Saved to Drive</small></span>
              <span className={styles.sheetShare}>Share</span>
            </div>
            <div className={styles.sheetToolbar}>
              File <span>Edit</span>
              <span>View</span><span>Insert</span><span>Format</span>
          ...
          <article className={`${styles.card} ${styles.chat}`}>
            <div className={styles.cardBar}>
              <span className={styles.chatMark}><Hash size={14} /></span>
              <span>dispatch <small>9 members</small></span>
              <span className={styles.unread}>2 new</span>
            </div>
            <div className={styles.chatThread}>
              <div className={styles.chatMessage}>
                <b className={styles.chatAvatar}>MR</b>
                <div><span className={styles.messageMeta}>Marco Ruiz <time>9:32</time></span><p className={styles.messageBubble}>Sheet says <strong>200</strong>. Are we shipping 240?</p></div>
              </div>
              <div className={`${styles.chatMessage} ${styles.chatMessageOwn}`}>
                <div><span className={styles.messageMeta}>Alex Lee <time>9:34</time></span><p className={styles.messageBubble}>Checking with sales now.</p></div>
              </div>
              <div className={styles.chatMessage}>
                <b className={`${styles.chatAvatar} ${styles.chatAvatarBlue}`}>SB</b>
                <div><span className={styles.messageMeta}>Sofía Bianchi <time>9:36</time></span><p className={styles.messageBubble}>Dispatch has Friday held. Need the final quantity.</p></div>
              </div>
            </div>
          </article>
          <article className={`${styles.card} ${styles.approval}`}>
            <div className={styles.cardBar}>
              <span className={styles.approvalMark}><ShieldCheck size={14} /></span>
              <span>Purchase approval <small>Procurement</small></span>
              <Circle size={12} />
            </div>
            <div className={styles.cardBody}>
              ...
              <div className={styles.approvalActions}><span>Review request</span><span>View policy ↗</span></div>
            </div>
          </article>
          <div className={`${styles.floatingMessage} ${styles.floatingMessageOne}`}>
            <b>EL</b><span><strong>Emma Lewis</strong><small>Just confirming: 240, please.</small></span>
          </div>
          <div className={`${styles.floatingMessage} ${styles.floatingMessageTwo}`}>
            <b>AL</b><span><strong>Alex Lee</strong><small>Is PO–2084 approved yet?</small></span>
          </div>
        </div>
